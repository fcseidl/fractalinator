...
class Viewer:
    ...
    ----------
    fractal:
        a mandelbrot.KBrot instance to view.
    topleft:
        top left corner of viewing window in the complex plane. Default: -2+2j
    bottomright:
        bottom right corner of viewing window in the complex plane. Default: 2-2j
    pixels_per_unit:
        sets resolution so that a unit square in C contains this many pixels, squared. Default: 200
    input_transform:
        transformation to be applied to a pixel's complex coordinate before coloring according
